Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/SwiftBond/Bond.git", :tag => "v3.10.0" }
  s.source_files  = ["Bond", "Bond/Shared", "Bond/OSX", "Bond/iOS"]
  s.ios.exclude_files = "Bond/OSX"
  s.osx.exclude_files = "Bond/iOS"
