Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/SwiftBond/Bond.git", :tag => "6.4.2" }
  ...
  s.pod_target_xcconfig = { "OTHER_SWIFT_FLAGS" => "-DBUILDING_WITH_XCODE $(inherited)", "SWIFT_VERSION" => "4.0" }
  s.requires_arc = true

  s.dependency "ReactiveKit", "~> 3.7.4"
